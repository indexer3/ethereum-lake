...
// UniswapV3NFTPositionManagerMetaData contains all meta data concerning the UniswapV3NFTPositionManager contract.
var UniswapV3NFTPositionManagerMetaData = &bind.MetaData{
...
// Deprecated: Use UniswapV3NFTPositionManagerMetaData.ABI instead.
var UniswapV3NFTPositionManagerABI = UniswapV3NFTPositionManagerMetaData.ABI
...
func bindUniswapV3NFTPositionManager(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := UniswapV3NFTPositionManagerMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
